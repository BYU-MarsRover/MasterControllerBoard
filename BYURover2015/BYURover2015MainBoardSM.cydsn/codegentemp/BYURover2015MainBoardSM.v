...
module top ;
    ...
    TCPWM_P4_v1_10_2 SignalGenerator (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
        ...
        .line_n(Net_495),
        .clock(Net_452));
    defparam SignalGenerator.PWMCountMode = 3;
    defparam SignalGenerator.PWMReloadMode = 0;
    defparam SignalGenerator.PWMReloadPresent = 0;
    defparam SignalGenerator.PWMStartMode = 0;
    defparam SignalGenerator.PWMStopMode = 0;
    defparam SignalGenerator.PWMSwitchMode = 0;
    defparam SignalGenerator.QuadIndexMode = 0;
    defparam SignalGenerator.QuadPhiAMode = 3;
    defparam SignalGenerator.QuadPhiBMode = 3;
    defparam SignalGenerator.QuadStopMode = 0;
    defparam SignalGenerator.TCCaptureMode = 0;
    defparam SignalGenerator.TCCountMode = 3;
    defparam SignalGenerator.TCReloadMode = 0;
    defparam SignalGenerator.TCStartMode = 0;
    defparam SignalGenerator.TCStopMode = 0;
