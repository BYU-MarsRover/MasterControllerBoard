...
#define Timer1_PWM_MODE_CENTER                (Timer1_CC_MATCH_INVERT       |   \
                                                         Timer1_OVERLOW_NO_CHANGE     |   \
                                                         Timer1_UNDERFLOW_CLEAR)
#define Timer1_PWM_MODE_ASYM                  (Timer1_CC_MATCH_NO_CHANGE    |   \
                                                         Timer1_OVERLOW_SET           |   \
                                                         Timer1_UNDERFLOW_CLEAR )
