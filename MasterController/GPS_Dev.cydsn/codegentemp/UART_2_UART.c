...
#include "UART_2_SPI_UART_PVT.h"
    ...
    *******************************************************************************/
    void UART_2_UartInit(const UART_2_UART_INIT_STRUCT *config)
    {
        ...
        {
            /* Configure pins */
            UART_2_SetPins(UART_2_SCB_MODE_UART, config->mode, config->direction);
            ...
            UART_2_CTRL_REG     |= UART_2_GET_CTRL_ADDR_ACCEPT(config->multiprocAcceptAddr) |
                                             UART_2_CTRL_UART;
...
void UART_2_UartSetRxAddressMask(uint32 addressMask)
{
    ...
    *******************************************************************************/
    CY_ISR(UART_2_UART_WAKEUP_ISR)
    {
        ...
        * by UART_2_UartRestoreConfig() call.
        */
    #if(UART_2_SCB_MODE_UNCONFIG_CONST_CFG)
        #if(UART_2_MOSI_SCL_RX_WAKE_PIN)
            (void) UART_2_spi_mosi_i2c_scl_uart_rx_wake_ClearInterrupt();
